...
export const JustLetMeLieDown = ({data})  => {
  if (!data) return null
        ...
        <h1>{document.title.text}</h1>
            <div className="page-content">
              ...
              <div className='text-content-right'>
                ...
                <RichText class="mb-1" render={document.reviews[1].review.raw}/>
...
query JustLetMeQuery {
  prismicBookPage(uid: {eq: "just-let-me-lie-down"}) {
    uid
    data {
      title {
        text
...
export default JustLetMeLieDown;